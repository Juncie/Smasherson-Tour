                    ...
                    <div className="flex flex-wrap -mx-4 lg:justify-between">
                        <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                            <div className="mb-12 max-w-[570px] lg:mb-0">
                                ...
                                <h2 className="mb-6 text-[32px] tracking-wider uppercase text-dark sm:text-[40px] lg:text-[36px] xl:text-[40px]">
                                    GET IN TOUCH
                                </h2>
                                <p className="text-lg leading-relaxed mb-9 text-body-color">
                                    <Balancer>
                                        Have any questions, comments, or just
                                        want to say hi 👋? We’d love to hear
                                        from you! Fill out the form below and
                                ...
                                <div className="mb-8 flex w-full max-w-[370px]">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="text-base text-body-color">
                                            <a
                                                href="tel:4806442291"
                                                className="text-primary hover:text-primary/75 transition duration-150"
                                            >
                                                (480) 644-2291
                                            </a>
                                        </p>
