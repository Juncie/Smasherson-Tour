...
export default function SignUp() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        const API_URL = `https://staging-be.smasherson.com/api/v1/users/sign_up`
        ...
        try {
            ...
            // If the success flag is false, display the error message.
            if (!data.success && data.message) {
                setErrorMessage(data.message)
            } else {
                // Success case, clear the error message if any.
                setErrorMessage('')
            }
        } catch (error) {
