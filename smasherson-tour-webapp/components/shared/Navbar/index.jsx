...
export default function NavBar() {
    ...
    return (
        <>
            <header className="sticky top-0 z-30 w-screen overflow-hidden">
                <nav className="bg-white border-gray-200 flex justify-between px-4 lg:px-6 py-2.5 dark:bg-gray-800">
