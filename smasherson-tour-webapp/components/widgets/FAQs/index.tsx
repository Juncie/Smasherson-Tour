...
const FAQs = () => {
    return (
        <section className="relative z-20 overflow-hidden px-16 pt-20 pb-12 lg:pt-[120px] lg:pb-[90px]">
...
const AccordionItem = ({ header, text }) => {
    ...
    return (
        <div className="single-faq mb-8 w-full rounded-lg border border-[#F3F4FE] p-4 sm:p-8 lg:px-6 xl:px-8">
            <button
            ...
            >
                ...
                <div className="w-full">
                    <h4 className="text-lg tracking-wider">{header}</h4>
                </div>
            </button>
