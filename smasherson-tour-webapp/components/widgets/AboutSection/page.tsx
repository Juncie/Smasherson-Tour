                    ...
                    <div className="md:7/12 lg:w-1/2 space-y-2">
                        ...
                        <div className="divide-y space-y-4 divide-gray-100 dark:divide-gray-800">
                            <div className="mt-8 flex gap-4 md:items-center">
                                <div className="w-12 h-12 flex justify-center items-center gap-4 rounded-full bg-orange-100 dark:bg-orange-900/20">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 24 24"
                                        fill="currentColor"
                                        className="w-6 h-6 m-auto text-orange-600 dark:text-orange-400"
                                    >
                                        <path
                                            fill-rule="evenodd"
