          ...
          <div className="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
            <div className="mx-auto w-full max-w-xl lg:w-96">
              <div>
                ...
                <h2 className="mt-6 text-3xl font-extrabold text-neutral-600">Hey There!</h2>
              </div>
              ...
              <div className="mt-8">
                <div className="mt-6">
                  <form action="#" method="POST" className="space-y-6" data-bitwarden-watching="1">
                    ...
                    <div className="space-y-1">
                      <label htmlFor="confirm-password" className="block text-sm font-medium text-neutral-600">
                        {' '}
                        Confirm Password{' '}
                      </label>
                      <div className="mt-1">
